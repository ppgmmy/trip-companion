...
import { DEFAULT_PAYER_ID, PAYER_PRESETS, PAYMENT_METHODS, payerLabel, paymentMethodLabel } from "../data";
...
export default function PayerPaymentFields({
  ...
  const displayPayer = customPayer.trim() || payerLabel(payer) || "ppg";
    ...
    <div className="rounded-2xl border border-jade/15 bg-mist/40">
      ...
      >
        <div className="min-w-0">
          <p className="text-[10px] font-semibold uppercase tracking-wider text-ink-faint">支付方式 · 其他選項</p>
      ...
      {open && (
        <div className="space-y-3 border-t border-jade/10 px-3 pb-3 pt-3">
          <div>
            <p className="mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-ink-faint">其他付款人</p>
